...
test('Generate valid input keys and patch the action.yaml file', () => {
    ...
    const actions = yaml.load(fs.readFileSync('action.yaml', 'utf8')) as {inputs: {[index:string]:{description:string, default:(string | number), required: boolean}}}
